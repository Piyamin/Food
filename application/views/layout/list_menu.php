        ...
        <div class="tab-pane fade show active single-member" id="Special" role="tabpanel" aria-labelledby="Special-tab">
            <div class="row">
                <div class="col-sm-6 col-lg-6">
                    ...
                    <div class="single_food_item media">
                        <img src="<?php echo base_url('public/img/food_menu/single_food_2.png') ?>" class="mr-3" alt="...">
                        <div class="media-body align-self-center">
                    ...
                    <div class="single_food_item media">
                        <img src="<?php echo base_url('public/img/food_menu/single_food_3.png') ?>" class="mr-3" alt="...">
                        <div class="media-body align-self-center">
                ...
                <div class="col-sm-6 col-lg-6">
                    <div class="single_food_item media">
                        <img src="<?php echo base_url('public/img/food_menu/single_food_4.png') ?>" class="mr-3" alt="...">
                        <div class="media-body align-self-center">
                    ...
                    <div class="single_food_item media">
                        <img src="<?php echo base_url('public/img/food_menu/single_food_5.png') ?>" class="mr-3" alt="...">
                        <div class="media-body align-self-center">
                    ...
                    <div class="single_food_item media">
                        <img src="<?php echo base_url('public/img/food_menu/single_food_6.png') ?>" class="mr-3" alt="...">
                        <div class="media-body align-self-center">
                            <h3>Chicken Roast</h3>
                            <p>They're wherein heaven seed hath nothing</p>
                            <h5>$40.00</h5>
